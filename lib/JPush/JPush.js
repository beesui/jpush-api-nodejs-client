...
var PUSH_API_URL = 'https://push.midea.com:19090/v3/push';
var REPORT_API_URL = 'https://report.midea.com:19090/v3';
var REPORT_RECEVIED = "/received";
var REPORT_USER = "/users";
var REPORT_MESSAGE = "/messages";
var USER_AGENT = 'JPush-API-NodeJS-Client';
var HOST_NAME_SSL = "https://push.midea.com:19090";
...
function JPushClient(appKey, masterSecret, retryTimes, isDebug) {
    ...
    var b = new Buffer(appKey+':'+masterSecret);
    var authorization = 'Basic '+ b.toString('base64');
...
function sendPush(payload, callback) {
    ...
    return _request(PUSH_API_URL, payload, header, 'POST', 1, this.retryTimes, this.isDebug, callback);
}
...
function getReportReceiveds(msg_ids, callback) {
    ...
    return _request(url, null, header, 'GET', 1, this.retryTimes, this.isDebug, callback);
}
...
function updateDeviceTagAlias(registrationId, alias, clearTag, tagsToAdd,
    ...
    return _request(url, JSON.stringify(json), header, 'POST', 1, this.retryTimes, this.isDebug, callback);
}
...
function deleteTag(theTag, platform, callback) {
    ...
    return _request(url, null, header, 'delete', 1, this.retryTimes, this.isDebug, callback);
}
...
function validate(payload, callback) {
    ...
    return _request(PUSH_API_URL + VALIDATE, payload, header, 'POST', 1, this.retryTimes, this.isDebug, callback);
}

function _request(url, body, headers, method, times, maxTryTimes, isDebug, callback) {
    if (isDebug) {
    ...
    var _callback = function(err, res, body) {
        if (err) {
            ...
            if (times < maxTryTimes) {
                return _request(url, body, headers, method, times + 1,
